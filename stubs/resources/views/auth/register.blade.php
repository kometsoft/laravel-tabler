            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <x-tabler::label class="col-md-4 col-form-label text-md-end" :label="__('Name')"></x-tabler::label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <x-tabler::button type="submit" class="btn btn-primary" :label="__('Register')"></x-tabler::button>
                            </div>
                        </div>
                    </form>
                </div>
